import svgPaths from "./svg-wda84jyke7";
...
function MainEventsAllEvents() {
  return (
    <div className="absolute bg-white blur-[25px] h-[3042px] left-0 overflow-clip top-0 w-[2312px]" data-name="MAIN - EVENTS & ALL EVENTS">
      <Designs />
      <Box10StreetClean />
      <Box9Checkup />
      <Box12KidCompetition />
...
function LogOutCard() {
  return (
    <div className="absolute h-[470px] left-[636px] top-[1231px] w-[1041px]" data-name="LOG OUT CARD">
      <div className="absolute bg-white border border-[#5d5b5b] border-solid h-[470px] left-0 rounded-[30px] top-0 w-[1041px]" />
      <div className="absolute bg-[#d9d9d9] h-[82px] left-[67px] rounded-[10px] top-[348px] w-[427px]" />
      <div className="absolute bg-[#78aad7] h-[82px] left-[547px] rounded-[10px] top-[348px] w-[427px]" />
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Poppins:Medium',sans-serif] h-[52px] leading-[normal] left-[520.5px] not-italic text-[#5d5b5b] text-[40px] text-center top-[183px] w-[747px]">Are you sure you want to log out?</p>
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Poppins:Medium',sans-serif] h-[52px] leading-[normal] left-[280.5px] not-italic text-[#5d5b5b] text-[40px] text-center top-[363px] w-[219px]">BACK</p>
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Poppins:Medium',sans-serif] h-[52px] leading-[normal] left-[760.5px] not-italic text-[40px] text-center text-white top-[363px] w-[219px]">CONFIRM</p>
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Poppins:SemiBold',sans-serif] h-[74.289px] leading-[normal] left-[519.64px] not-italic text-[#78aad7] text-[64px] text-center top-[42px] w-[347.276px]">LOG OUT</p>
    </div>
  );
}
